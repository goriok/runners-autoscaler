...
import pytest
from autoscaler.strategy.manual import ManualRunnersScaler
from tests.helpers import capture_output


@mock.patch.dict(os.environ, {'BITBUCKET_USERNAME': 'test', 'BITBUCKET_APP_PASSWORD': 'test', 'DEBUG': 'true'})
class ManualRunnersScalerTestCase(TestCase):
    ...
    def test_get_runners(self, get_runners_request):
        ...
        runner_count_scaler = ManualRunnersScaler(runner_data=runner_data)
    ...
    @mock.patch('autoscaler.strategy.manual.ManualRunnersScaler.get_runners')
    def test_run_nothing_to_do(self, mock_get_runners):
        ...
        service = ManualRunnersScaler(runner_data=runner_data)
    ...
    @mock.patch('autoscaler.strategy.manual.DEFAULT_SLEEP_TIME_RUNNER_SETUP', 0.1)
    @mock.patch('autoscaler.strategy.manual.ManualRunnersScaler.get_runners')
    ...
    @mock.patch('autoscaler.strategy.manual.DEFAULT_SLEEP_TIME_RUNNER_DELETE', 0.1)
    @mock.patch('autoscaler.strategy.manual.ManualRunnersScaler.get_runners')
