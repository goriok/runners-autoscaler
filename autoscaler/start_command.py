...
from autoscaler.core.helpers import required, enable_debug
from autoscaler.core.constants import BITBUCKET_RUNNER_API_POLLING_INTERVAL
...
def main():
    ...
    for runner_data in autoscale_runners[:1]:
        ...
        autoscaler = PctRunnersIdleScaler(runner_data)
        while True:
            autoscaler.run()
