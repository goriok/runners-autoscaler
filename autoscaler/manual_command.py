...
from autoscaler.clients.kubernetes.base import KubernetesSpecFileAPIService, KubernetesBaseAPIService
from autoscaler.core.logger import logger
from autoscaler.strategy.manual import ManualRunnersScaler
from autoscaler.core.helpers import required, enable_debug, fail, string_to_base64string
from autoscaler.core.constants import (
    DEFAULT_RUNNER_KUBERNETES_NAMESPACE, DEFAULT_SLEEP_TIME_RUNNER_SETUP,
...
def main():
    ...
    for runner_data in manual_runners:
        ...
        count_scaler = ManualRunnersScaler(runner_data)
        count_scaler.run()
